...
<body class="h-full bg-gray-50">
    <!-- Hero Section -->
    <div class="bg-gradient-to-br from-sage-600 via-sage-400 to-sage-700 relative overflow-hidden">
        <!-- Éléments de fond animés -->
        <div class="absolute inset-0">
            <div class="absolute top-10 left-10 w-20 h-20 bg-white/10 rounded-full animate-bounce"></div>
            <div class="absolute top-32 right-20 w-16 h-16 bg-green-300/20 rounded-full animate-pulse"></div>
            <div class="absolute bottom-20 left-1/4 w-24 h-24 bg-lime-300/15 rounded-full animate-ping"></div>
            <div class="absolute bottom-32 right-10 w-12 h-12 bg-emerald-300/20 rounded-full animate-spin"></div>
        </div>

        <div class="relative px-6 py-24 mx-auto max-w-7xl lg:px-8">
            <div class="text-center">
                <!-- Logo -->
                <div class="flex justify-center mb-8">
                    <div class="w-20 h-20 bg-white rounded-3xl shadow-2xl flex items-center justify-center">
                        <svg class="w-10 h-10 text-sage-700" fill="currentColor" viewBox="0 0 20 20">
                ...
                <p class="text-xl text-green-100 mb-8">
                    Transport de colis mondial - Suivi en temps réel
                </p>
